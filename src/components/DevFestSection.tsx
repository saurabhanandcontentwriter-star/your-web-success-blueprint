          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-3xl md:text-5xl font-display font-bold">
                Google{" "}
                <span className="gradient-text">DevFest Ranchi 2026</span>
              </h2>
            </div>
            ...
            <p className="text-muted-foreground max-w-2xl mb-4">
              {phase === "upcoming" ? (
                ...
                <>
                  ...
                  <strong className="text-foreground">31st October 2026</strong>{" "}
                  at{" "}
                  <strong className="text-foreground">
                    BIT Mesra Auditorium, Ranchi
                  </strong>
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mb-2">
              ...
              series, organised worldwide by Google Developer Groups (GDG). Every
              edition brings developers, students, designers and founders together
              for hands-on sessions on Android, Web, Cloud, Firebase, Flutter and
              AI with Gemini.
            </p>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              <button
                type="button"
                onClick={() => setShowPopup(true)}
                className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-primary to-accent text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity cursor-pointer"
                aria-label="Open DevFest registration popup"
              >
                Register Now
                <ArrowRight size={15} />
              </button>
              ...
              >
                <Mic size={15} />
                {phase === "past" ? "Share Feedback" : "Become a Speaker"}
              </a>
