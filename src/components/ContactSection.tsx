...
import { MapPin, Phone, Send, Linkedin, Mail, Download, FileText } from "lucide-react";
    ...
    <section id="contact" className="py-24">
      ...
      <div className="container mx-auto px-6">
        ...
        <p className="text-muted-foreground max-w-2xl mb-10">
          Available for Data Analyst roles, SEO & Digital Marketing consulting, and freelance
          projects. Download my resume or send a message below.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl">
          <div className="space-y-6">
            <p className="text-muted-foreground">
              Ready to turn data into growth? Reach out for analytics dashboards, SEO audits,
              content strategy, or full-time opportunities.
            </p>
            <div className="space-y-4">
              <a href={`mailto:${EMAIL}`} className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
                <Mail size={18} className="text-primary shrink-0" />
                {EMAIL}
              </a>
              <a href={`tel:${PHONE.replace(/\s/g, "")}`} className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
