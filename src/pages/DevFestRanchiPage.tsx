...
const speakers = [
  { name: "Speaker Lineup", role: "Official speakers will be announced soon", tag: "Coming Soon", initials: "🎤" },
  { name: "Google Developer Community", role: "GDG Ranchi community sessions", tag: "Community", initials: "GDG" },
  { name: "More Speakers", role: "Announcements coming soon", tag: "TBA", initials: "+" },
];
      ...
      <main className="pt-24">
        <section className="relative container mx-auto px-6 pt-10 pb-20 md:pt-20 md:pb-28">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-3"><a href={REGISTRATION_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-accent px-8 py-4 text-sm font-bold text-primary-foreground shadow-xl hover:scale-[1.02] transition-transform">Register Now <ArrowRight size={17} /></a><a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/5 px-8 py-4 text-sm font-bold hover:bg-red-500/10"><Play size={17} className="fill-current" /> Watch on YouTube</a><a href="#speakers" className="inline-flex items-center gap-2 rounded-full border border-border bg-background/50 px-8 py-4 text-sm font-bold hover:bg-secondary"><Users size={17} /> Meet Speakers</a></div>
        ...
        <section id="youtube" className="container mx-auto scroll-mt-24 px-6 pb-20 md:pb-28"><div className="mx-auto max-w-6xl"><div className="mb-9 text-center"><p className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-red-500"><Play size={14} className="fill-current" /> DevFest on YouTube</p><h2 className="mt-3 text-3xl font-display font-bold md:text-4xl">Watch the DevFest Video</h2><p className="mx-auto mt-3 max-w-2xl text-muted-foreground">Watch the DevFest Ranchi community video directly from this page.</p></div><div className="glass-card mx-auto max-w-5xl overflow-hidden border-red-500/20 p-2 shadow-2xl"><div className="relative aspect-video overflow-hidden rounded-2xl bg-black"><iframe className="absolute inset-0 h-full w-full" src={YOUTUBE_EMBED_URL} title="DevFest Ranchi 2026 YouTube Video" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></div><div className="mt-6 text-center"><a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/5 px-6 py-3 text-sm font-bold hover:bg-red-500/10"><Play size={16} className="fill-current text-red-500" /> Open on YouTube <ExternalLink size={15} /></a></div></div></section>
        ...
        <section className="container mx-auto px-6 pb-28"><div className="mx-auto max-w-5xl glass-card p-8 text-center md:p-14"><CheckCircle2 className="mx-auto text-primary" size={32} /><h2 className="mt-4 text-3xl font-display font-bold md:text-5xl">See you at DevFest Ranchi 2026.</h2><p className="mx-auto mt-4 max-w-2xl text-muted-foreground">31st October • BIT Mesra Auditorium • Community 2.0</p><div className="mt-7 flex flex-wrap justify-center gap-3"><a href={REGISTRATION_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-accent px-8 py-4 text-sm font-bold text-primary-foreground shadow-xl hover:opacity-90">Register Now <ArrowRight size={17} /></a><a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/5 px-7 py-4 text-sm font-bold hover:bg-red-500/10"><Play size={16} className="fill-current text-red-500" /> Watch Video</a></div></div></section>
      </main>
